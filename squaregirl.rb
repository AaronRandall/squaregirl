...
class Level
  ...
  def block_objects
    level_blocks = 
      ...
      "                                                                                                                                                                                                              X                                                                   XXXXX                           |" +
      "                                                          XXX                                             X      XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX                                                                                                          X                                |" +
      "                                                  XX                                                                                                                  XX                                                                                                        X                                 |" +
      "                                                                                                                 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXX                                                                                             X                                           |" +
      "                                                                                                           X                                                          XXXX                                     X                                                       X                                          |" +
      "                                           XXX                                                                                                                        XXXXX                                                                                             X                                         |" +
      "                                                                                                                                                                      XXXXXX                                      X                                                                                               |" +
      "                                                                                                           XXXXX                                                      XXXXXXX                                                                                                                                     |" +
      "                                XXXXXXX                                                                                                                               XXXXXXXX                                X                                                                                                   |" +
      "                                                                                                                                                                      XXXXXXXXX                                                                                                                                   |" +
      "                          XXXX                                                                            XXXXXXXXXXXX                                                XXXXXXXXXX                       XXXXX     XXXXXXXXXX                                                                                       |" +
      "                                                                                                                                                                      XXXXXXXXXXX                                                                                                                                 |" +
      "                                                                                                                                                                      XXXXXXXXXXXX                                                                                                                                |" +
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX     XXXXXXXXXXXXXXXXXXX                    XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX       XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX                                                      XXXXXXXXXXXXXXXXXXXXX|"
...
class Window < Gosu::Window
  ...
  def setup_level
    @squaregirl = SquareGirl.new(self)
...
class SquareGirl
  ...
  def move_left
    @window.objects.each do |object|
      # if any of the objects right-hand-sides are touching the left-hand-side of squaregirl, prevent movement
  ...
  def move_up
    @window.objects.each do |object|
      # if any of the objects bottom-sides are touching the top-side of squaregirl, prevent movement
    ...
    # TODO: play with this interval so there are two speeds when jumping, fast initially, then slow
    @y = @y - (@window.movement_interval * 2)
    return true
  end

  def move_down
    @window.objects.each do |object|
      # if any of the objects top-sides are touching the bottom-side of squaregirl, prevent movement
